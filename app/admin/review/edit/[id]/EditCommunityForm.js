...
import { updateCommunityUtility } from '@/app/admin/actions';

export default function EditCommunityForm({ utility }) {
    return (
        <form action={updateCommunityUtility.bind(null, utility.id)}>
